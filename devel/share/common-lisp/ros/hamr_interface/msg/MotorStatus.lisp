...
(cl:defmethod cl:initialize-instance :after ((m <MotorStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MotorStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hamr_interface-msg:<MotorStatus> is deprecated: use hamr_interface-msg:MotorStatus instead.")))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <MotorStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hamr_interface-msg:position-val is deprecated.  Use hamr_interface-msg:position instead.")
  (position m))

(cl:ensure-generic-function 'velocity-val :lambda-list '(m))
(cl:defmethod velocity-val ((m <MotorStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hamr_interface-msg:velocity-val is deprecated.  Use hamr_interface-msg:velocity instead.")
  (velocity m))

(cl:ensure-generic-function 'desired_velocity-val :lambda-list '(m))
(cl:defmethod desired_velocity-val ((m <MotorStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hamr_interface-msg:desired_velocity-val is deprecated.  Use hamr_interface-msg:desired_velocity instead.")
  (desired_velocity m))

(cl:ensure-generic-function 'speed_cmd-val :lambda-list '(m))
(cl:defmethod speed_cmd-val ((m <MotorStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hamr_interface-msg:speed_cmd-val is deprecated.  Use hamr_interface-msg:speed_cmd instead.")
  (speed_cmd m))

(cl:ensure-generic-function 'pidError-val :lambda-list '(m))
(cl:defmethod pidError-val ((m <MotorStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hamr_interface-msg:pidError-val is deprecated.  Use hamr_interface-msg:pidError instead.")
  (pidError m))
