...
(cl:defclass <HamrStatus> (roslisp-msg-protocol:ros-message)
  ((timestamp
   ...
   (left_motor
    :reader left_motor
    :initarg :left_motor
    :type hamr_interface-msg:MotorStatus
    :initform (cl:make-instance 'hamr_interface-msg:MotorStatus))
   (right_motor
    :reader right_motor
    :initarg :right_motor
    :type hamr_interface-msg:MotorStatus
...
(cl:defmethod cl:initialize-instance :after ((m <HamrStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'HamrStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hamr_interface-msg:<HamrStatus> is deprecated: use hamr_interface-msg:HamrStatus instead.")))

(cl:ensure-generic-function 'timestamp-val :lambda-list '(m))
(cl:defmethod timestamp-val ((m <HamrStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hamr_interface-msg:timestamp-val is deprecated.  Use hamr_interface-msg:timestamp instead.")
  (timestamp m))

(cl:ensure-generic-function 'looptime-val :lambda-list '(m))
(cl:defmethod looptime-val ((m <HamrStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hamr_interface-msg:looptime-val is deprecated.  Use hamr_interface-msg:looptime instead.")
  (looptime m))

(cl:ensure-generic-function 'left_motor-val :lambda-list '(m))
(cl:defmethod left_motor-val ((m <HamrStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hamr_interface-msg:left_motor-val is deprecated.  Use hamr_interface-msg:left_motor instead.")
  (left_motor m))

(cl:ensure-generic-function 'right_motor-val :lambda-list '(m))
(cl:defmethod right_motor-val ((m <HamrStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hamr_interface-msg:right_motor-val is deprecated.  Use hamr_interface-msg:right_motor instead.")
  (right_motor m))

(cl:ensure-generic-function 'turret_motor-val :lambda-list '(m))
(cl:defmethod turret_motor-val ((m <HamrStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hamr_interface-msg:turret_motor-val is deprecated.  Use hamr_interface-msg:turret_motor instead.")
  (turret_motor m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<HamrStatus>)))
  ...
  (cl:format cl:nil "time timestamp~%uint16 looptime~%hamr_interface/MotorStatus left_motor~%hamr_interface/MotorStatus right_motor~%hamr_interface/MotorStatus turret_motor~%================================================================================~%MSG: hamr_interface/MotorStatus~%uint16 position~%int16 velocity~%int16 desired_velocity~%int16 speed_cmd~%int16 pidError~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'HamrStatus)))
  "Returns full string definition for message of type 'HamrStatus"
  (cl:format cl:nil "time timestamp~%uint16 looptime~%hamr_interface/MotorStatus left_motor~%hamr_interface/MotorStatus right_motor~%hamr_interface/MotorStatus turret_motor~%================================================================================~%MSG: hamr_interface/MotorStatus~%uint16 position~%int16 velocity~%int16 desired_velocity~%int16 speed_cmd~%int16 pidError~%~%"))
