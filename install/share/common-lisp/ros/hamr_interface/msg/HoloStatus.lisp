...
(cl:defmethod cl:initialize-instance :after ((m <HoloStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'HoloStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hamr_interface-msg:<HoloStatus> is deprecated: use hamr_interface-msg:HoloStatus instead.")))

(cl:ensure-generic-function 'setpoint_x-val :lambda-list '(m))
(cl:defmethod setpoint_x-val ((m <HoloStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hamr_interface-msg:setpoint_x-val is deprecated.  Use hamr_interface-msg:setpoint_x instead.")
  (setpoint_x m))

(cl:ensure-generic-function 'setpoint_y-val :lambda-list '(m))
(cl:defmethod setpoint_y-val ((m <HoloStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hamr_interface-msg:setpoint_y-val is deprecated.  Use hamr_interface-msg:setpoint_y instead.")
  (setpoint_y m))

(cl:ensure-generic-function 'setpoint_r-val :lambda-list '(m))
(cl:defmethod setpoint_r-val ((m <HoloStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hamr_interface-msg:setpoint_r-val is deprecated.  Use hamr_interface-msg:setpoint_r instead.")
  (setpoint_r m))

(cl:ensure-generic-function 'xdot-val :lambda-list '(m))
(cl:defmethod xdot-val ((m <HoloStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hamr_interface-msg:xdot-val is deprecated.  Use hamr_interface-msg:xdot instead.")
  (xdot m))

(cl:ensure-generic-function 'ydot-val :lambda-list '(m))
(cl:defmethod ydot-val ((m <HoloStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hamr_interface-msg:ydot-val is deprecated.  Use hamr_interface-msg:ydot instead.")
  (ydot m))

(cl:ensure-generic-function 'tdot-val :lambda-list '(m))
(cl:defmethod tdot-val ((m <HoloStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hamr_interface-msg:tdot-val is deprecated.  Use hamr_interface-msg:tdot instead.")
  (tdot m))

(cl:ensure-generic-function 'left_vel-val :lambda-list '(m))
(cl:defmethod left_vel-val ((m <HoloStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hamr_interface-msg:left_vel-val is deprecated.  Use hamr_interface-msg:left_vel instead.")
  (left_vel m))

(cl:ensure-generic-function 'right_vel-val :lambda-list '(m))
(cl:defmethod right_vel-val ((m <HoloStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hamr_interface-msg:right_vel-val is deprecated.  Use hamr_interface-msg:right_vel instead.")
  (right_vel m))

(cl:ensure-generic-function 'turret_vel-val :lambda-list '(m))
(cl:defmethod turret_vel-val ((m <HoloStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hamr_interface-msg:turret_vel-val is deprecated.  Use hamr_interface-msg:turret_vel instead.")
  (turret_vel m))

(cl:ensure-generic-function 'desired_left_vel-val :lambda-list '(m))
(cl:defmethod desired_left_vel-val ((m <HoloStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hamr_interface-msg:desired_left_vel-val is deprecated.  Use hamr_interface-msg:desired_left_vel instead.")
  (desired_left_vel m))

(cl:ensure-generic-function 'desired_right_vel-val :lambda-list '(m))
(cl:defmethod desired_right_vel-val ((m <HoloStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hamr_interface-msg:desired_right_vel-val is deprecated.  Use hamr_interface-msg:desired_right_vel instead.")
  (desired_right_vel m))

(cl:ensure-generic-function 'desired_turret_vel-val :lambda-list '(m))
(cl:defmethod desired_turret_vel-val ((m <HoloStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hamr_interface-msg:desired_turret_vel-val is deprecated.  Use hamr_interface-msg:desired_turret_vel instead.")
...
(cl:defmethod sensed_drive_angle-val ((m <HoloStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hamr_interface-msg:sensed_drive_angle-val is deprecated.  Use hamr_interface-msg:sensed_drive_angle instead.")
