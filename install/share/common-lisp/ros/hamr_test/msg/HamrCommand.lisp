...
(cl:defmethod cl:initialize-instance :after ((m <HamrCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'HamrCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hamr_test-msg:<HamrCommand> is deprecated: use hamr_test-msg:HamrCommand instead.")))

(cl:ensure-generic-function 'type-val :lambda-list '(m))
(cl:defmethod type-val ((m <HamrCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hamr_test-msg:type-val is deprecated.  Use hamr_test-msg:type instead.")
  (type m))

(cl:ensure-generic-function 'val-val :lambda-list '(m))
(cl:defmethod val-val ((m <HamrCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hamr_test-msg:val-val is deprecated.  Use hamr_test-msg:val instead.")
  (val m))
